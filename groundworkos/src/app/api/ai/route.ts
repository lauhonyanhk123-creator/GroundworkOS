  ...
  try {
    switch (toolName) {
      ...
      case 'create_client':
        ...
        return await clientTools.createClient(args as clientTools.CreateClientInput, supabase, cid);
      case 'get_client':
        return await clientTools.getClient(args as clientTools.GetClientInput, supabase);
      case 'search_clients':
        return await clientTools.searchClients(args as clientTools.SearchClientsInput, supabase, companyId);
      case 'get_client_history':
        return await clientTools.getClientHistory(args as clientTools.GetClientHistoryInput, supabase);
      case 'update_client':
        return await clientTools.updateClient(args as clientTools.UpdateClientInput, supabase);

      // ── Jobs ─────────────────────────────────────────────────────────────────
      case 'create_job':
        if (!companyId) return { error: 'No company associated with this account' };
        return await jobTools.createJob(args as jobTools.CreateJobInput, supabase, cid);
      case 'update_job_status':
        return await jobTools.updateJobStatus(args as jobTools.UpdateJobStatusInput, supabase, companyId);
      case 'update_job_progress':
        return await jobTools.updateJobProgress(args as jobTools.UpdateJobProgressInput, supabase);
      case 'get_job_details':
        return await jobTools.getJobDetails(args as jobTools.GetJobDetailsInput, supabase);
      case 'list_jobs':
      ...
      case 'get_entity_history':
        return await jobTools.getEntityHistory(args as jobTools.GetEntityHistoryInput, supabase);

      // ── Quotes ───────────────────────────────────────────────────────────────
      case 'create_quote':
        if (!companyId) return { error: 'No company associated with this account' };
        return await quoteTools.createQuote(args as quoteTools.CreateQuoteInput, supabase, cid);
      case 'update_quote':
        return await quoteTools.updateQuote(args as quoteTools.UpdateQuoteInput, supabase);
      case 'send_quote':
        return await quoteTools.sendQuote(args as quoteTools.SendQuoteInput, supabase);
      case 'accept_quote':
        return await quoteTools.acceptQuote(args as quoteTools.AcceptQuoteInput, supabase);
      case 'convert_quote_to_job':
        return await quoteTools.convertQuoteToJob(args as quoteTools.ConvertQuoteToJobInput, supabase);
      case 'list_quotes':
      ...
      case 'create_invoice':
        if (!companyId) return { error: 'No company associated with this account' };
        return await invoiceTools.createInvoice(args as invoiceTools.CreateInvoiceInput, supabase, cid);
      case 'mark_invoice_paid':
        return await invoiceTools.markInvoicePaid(args as invoiceTools.MarkInvoicePaidInput, supabase);
      ...
      case 'send_invoice':
        return await invoiceTools.sendInvoice(args as invoiceTools.SendInvoiceInput, supabase);

      // ── Subcontractors ───────────────────────────────────────────────────────
      case 'create_subcontractor':
        if (!companyId) return { error: 'No company associated with this account' };
        return await subconTools.createSubcontractor(args as subconTools.CreateSubcontractorInput, supabase, cid);
      case 'verify_cis_status':
        return await subconTools.verifyCISStatus(args as subconTools.VerifyCISStatusInput, supabase);
      case 'list_subcontractors':
        return await subconTools.listSubcontractors(supabase, companyId);
      case 'get_subcontractor_details':
        return await subconTools.getSubcontractorDetails(args as subconTools.GetSubcontractorDetailsInput, supabase);
      ...
      case 'create_schedule_entry':
        if (!companyId) return { error: 'No company associated with this account' };
        return await scheduleTools.createScheduleEntry(args as scheduleTools.CreateScheduleEntryInput, supabase, cid);
      ...
      case 'add_document':
        if (!companyId) return { error: 'No company associated with this account' };
        return await complianceTools.addDocument(args as complianceTools.AddDocumentInput, supabase, cid);
      ...
      case 'get_job_documents':
        return await complianceTools.getJobDocuments(args as complianceTools.GetJobDocumentsInput, supabase);
      case 'get_subcontractor_documents':
        return await complianceTools.getSubcontractorDocuments(args as complianceTools.GetSubcontractorDocumentsInput, supabase);
      ...
      case 'get_cis_monthly_return':
        return await reportingTools.getCISMonthlyReturn(args as reportingTools.GetCISMonthlyReturnInput, supabase);
      case 'get_subcontractor_payment_schedule':
        return await reportingTools.getSubcontractorPaymentSchedule(args as reportingTools.GetSubcontractorPaymentScheduleInput, supabase);
