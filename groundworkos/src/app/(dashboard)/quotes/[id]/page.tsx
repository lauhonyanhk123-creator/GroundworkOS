...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .badge { display: inline-block; padding: 4px 10px; border-radius: 4px; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; background: ${quote.status === 'accepted' ? '#d1fae5' : quote.status === 'declined' ? '#fee2e2' : '#fef9c3'}; color: ${quote.status === 'accepted' ? '#065f46' : quote.status === 'declined' ? '#991b1b' : '#713f12'}; }
