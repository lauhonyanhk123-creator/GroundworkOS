 ...
 */
router.post("/storage/uploads/request-url", requireRole("manager"), async (req: Request, res: Response) => {
 ...
 */
router.get("/storage/objects/*path", requireRole("manager"), async (req: Request, res: Response) => {
  try {
